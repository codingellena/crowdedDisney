...
bigmeta <- meta %>% 
  select(DATE,WDW_TICKET_SEASON,DAYOFWEEK,DAYOFYEAR,WEEKOFYEAR,MONTHOFYEAR, YEAR, HOLIDAYPX, HOLIDAYM,HOLIDAY,WDWSEASON,HOLIDAYN, WDWMEANTEMP, WDWeventN,MKeventN,EPeventN,HSeventN,AKeventN) %>% mutate(DATE=as.Date(DATE, format=c("%m/%d/%Y")))

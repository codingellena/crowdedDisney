...
bigmeta <- meta %>% 
  select(DATE,DAYOFWEEK,DAYOFYEAR,WEEKOFYEAR,MONTHOFYEAR, YEAR, HOLIDAYPX, HOLIDAYM,HOLIDAY, WDWTICKETSEASON,WDWSEASON,HOLIDAYN, WDWMEANTEMP) %>% mutate(DATE=as.Date(bigmeta$DATE, format=c("%m/%d/%Y")))
...
```
>>>>>>> e6d7a4f97aff05d8eb5007e5205676bbdc36c321
